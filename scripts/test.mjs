...
const checks = [
  ...
  "pause.test", "effectUpgrades.test", "pbrMaterials.test", "arenaPresentation.test", "gpuTextureTrace.test", "performance.test", "assetCache.test", "audioLifecycle.test", "audioAssets.test", "audioQuality.test", "musicScore.test",
