...
export const PLAYER_TEXT = {
  ...
  setup: {
    back: "← Back",
    start: "START",
    editSettings: "Edit match settings",
    ...
    loadout: {
      ...
      help: "Select a slot to change its weapon. Drag to reorder.",
      controlsHelp: "Controls help",
      detailedHelp: "Slots become keys 1–5 in game. Select a slot to reveal move and remove buttons, or drag on desktop to reorder. Search across all weapons or choose a category. Choosing an equipped weapon swaps slots. Use Done or Escape to close the picker.",
      preset: "Loadout",
      custom: "Custom loadout",
      manageSets: "Manage saved sets",
      picker: "Weapon picker",
      pickSlot: "Choose weapon for slot {slot}",
      editSlot: "Change slot {slot}: {weapon}",
      done: "Done",
      search: "Search all weapons",
      searchSummary: "{count} shown · A–Z",
      categories: "Weapon categories",
      noResults: "No weapons match your search.",
